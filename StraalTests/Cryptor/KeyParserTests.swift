...
class KeyParserTests: XCTestCase {
	...
	let example1CryptId: Data = Data(bytes: [UInt8]([0x06, 0xfc, 0x9a, 0xef, 0x59, 0x80, 0x02, 0x54]))

	let example1CryptKey: Data = Data(bytes: [UInt8]([0x16, 0x2a, 0x50, 0x5c, 0xa9, 0xfe, 0x7f, 0xb4, 0xc8, 0xa6, 0x04, 0xb5, 0x96, 0xa2, 0x3d, 0xcc, 0x31, 0x82, 0xa2, 0x9c, 0xa7, 0x23, 0x4b, 0x69, 0xf6, 0xc7, 0xe5, 0xb3, 0x3b, 0x7c, 0x57, 0xc9]))

	let example1CryptVector1: Data = Data(bytes: [UInt8]([0xe0, 0x9f, 0x69, 0x08, 0xfd, 0x1a, 0x36, 0x4f, 0xda, 0xf2, 0x5d, 0x5f, 0xa2, 0xbe, 0x9a, 0x31]))

	let example1CryptVector2: Data = Data(bytes: [UInt8]([0xf2, 0x52, 0x91, 0xf2, 0x04, 0xa0, 0x8b, 0x03, 0x06, 0x5c, 0xcb, 0xb5, 0x4a, 0xb1, 0x85, 0x2b]))
	...
	func testCryptKeyShouldInitializeWithData() {
		XCTAssertNotNil(try? CryptKey(cryptKeyData: Data(bytes: example1CryptFull)))
	}
